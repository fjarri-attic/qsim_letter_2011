...
An advantage of our method compared to the two-mode variational approach used elsewhere~\cite{Li2009}
is that it allows us to treat a large number of independent field modes,
thus including all the degrees of freedom that may be excited due to collisional
and nonlinear loss dynamics~\cite{Norrie2005,Deuar2007}.
...
it becomes one to a good approximation in the limit of large particle number,
...
\begin{equation}
	A_{i} = -i \left( K_{ij} + U_{ij} \lvert \Psi_{j} \rvert^{2} \right) \Psi_{i} -
