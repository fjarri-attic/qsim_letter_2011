...
\title{Quantitative simulations in three-dimensional atom interferometry}
...
phase-diffusion and squeezing in a three-dimensional Bose gas, with nonlinear losses
...
We show through comparison with interferometric measurements on Bose condensates,
that the theory predicts observed results, within experimental errors.
...
It can be represented using moments of wave operators $\widehat{\Psi}_1$
and $\widehat{\Psi}_2$~\cite{Li2009}.
The squeezing parameter for a Ramsey sequence is plotted on~\figref{fig:squeezing}.

The important feature of these quantum dynamical simulations
is that they are able to treat large numbers of atoms (40,000 in this case),
