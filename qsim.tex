...
\begin{figure}
	\begin{tabular}{l l}
	\imagetop{\hspace*{0.381in}\includegraphics[width=1.95in]{figures/ramsey_sequence.eps}} & \imagetop{(a)} \\
	\imagetop{\includegraphics{figures/ramsey_visibility.eps}} & \imagetop{(b)} \\
%	\vskip 0.2cm
	\imagetop{\hspace*{0.381in}\includegraphics[width=1.95in]{figures/echo_sequence.eps}} & \imagetop{(c)} \\
	\imagetop{\includegraphics{figures/echo_visibility.eps}} & \imagetop{(d)}
	\end{tabular}
...
\begin{figure}
	\begin{tabular}{l l}
	\imagetop{\includegraphics{figures/ramsey_phnoise.eps}} & \imagetop{(a)} \\
	%	\vskip 0.2cm
	\imagetop{\includegraphics{figures/echo_phnoise.eps}} & \imagetop{(b)}
	\end{tabular}
