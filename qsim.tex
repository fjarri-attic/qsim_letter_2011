...
\maketitle
	...
	\bogdansremark{It is better to avoid setting whole equations in bold --- we may need bold font for specific symbols (and I doubt that PRL style allows bold equations anyway)}
