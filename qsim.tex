...
\begin{abstract}
We develop a theory of quantum fluctuations and squeezing in a three-dimensional Bose-Einstein condensate atom interferometer with nonlinear losses.
...
with a BEC confined in a cigar-shaped magnetic trap with the frequencies $(97.0, 97.0, 11.69)\,\mathrm{Hz}$
in a bias magnetic field of $3.23\,\mathrm{G}$, so that magnetic field dephasing is largely eliminated~\cite{Hall1998}.
