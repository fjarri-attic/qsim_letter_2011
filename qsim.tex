...
however, Wigner simulations show that quantum noise is the dominant source of the visibility decay.

% FIXME: this old text will be kept for some time just in case.
