...
\usepackage{graphicx}
%\usepackage[justification=justified]{caption} % FIXME: 'justified' should be default, but it does not work
\usepackage{subfig}
\usepackage{amssymb}
\usepackage{bm}
...
\title{Quantitative noise in three-dimensional BEC interferometry}
