...
\begin{figure}
	...
	\imagetop{\hspace*{0.44in}\includegraphics[width=2.6in]{figures_precreated/ramsey_sequence.eps}} & \imagetop{(a)} \\
	\imagetop{\includegraphics{figures_generated/long_ramsey_visibility.eps}} & \imagetop{(b)} \\
%	\vskip 0.2cm
	\imagetop{\hspace*{0.44in}\includegraphics[width=2.6in]{figures_precreated/echo_sequence.eps}} & \imagetop{(c)} \\
...
\begin{figure}
	\includegraphics{figures_generated/ramsey_squeezing.eps}
