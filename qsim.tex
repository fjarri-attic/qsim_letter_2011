...
\begin{figure}
	\begin{tabular}{l l}
	\imagetop{\hspace*{0.381in}\includegraphics[width=1.95in]{figures_precreated/ramsey_sequence.pdf}} & \imagetop{(a)} \\
	\imagetop{\includegraphics{figures_generated/long_ramsey_visibility.pdf}} & \imagetop{(b)} \\
%	\vskip 0.2cm
	\imagetop{\hspace*{0.381in}\includegraphics[width=1.95in]{figures_precreated/echo_sequence.pdf}} & \imagetop{(c)} \\
...
\begin{figure}
	\includegraphics[width=8cm]{figures_generated/ramsey_squeezing.pdf}
