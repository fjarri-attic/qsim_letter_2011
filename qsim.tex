...
%	\vskip 0.2cm
	...
	Particle losses:
	$\kappa_{111} = 9.0 \times 10^{-31}\,\mathrm{cm^6/s}$~\cite{Mertes2007},
	$\kappa_{12} = 7.6 \times 10^{-15}\,\mathrm{cm^3/s}$,
	$\kappa_{22} = 1.675 \times 10^{-14}\,\mathrm{cm^3/s}$~\cite{Egorov2010}.}
...
\begin{figure}
	...
	except for the inter-component scattering length and corresponding loss rate:
