...
The basic Hamiltonian is easily expressed using quantum fields $\widehat{\Psi}_{i}^{\dagger}({\mathbf{x}}),\widehat{\Psi}_{j}({\mathbf{x}})$,
...
that allows a numerical simulation of the condensate quantum dynamics~\cite{Drummond_1993, Steel_1998}.
